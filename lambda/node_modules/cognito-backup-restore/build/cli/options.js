...
var verifyOptions = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mode, profile, region, key, secret, userpool, directory, file, password, passwordModulePath, delay, metadata, env, modeChoice, savedAWSProfiles_1, credentials, searchAWSProfile, awsProfileChoice, awsRegionChoice, cognitoISP, UserPools, userPoolList_1, searchCognitoPool, cognitoPoolChoice, directoryLocation, fileLocation, pwdModule;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                ...
                if (!(savedAWSProfiles_1.length && !savedAWSProfiles_1.includes(profile) && (!key || !secret))) return [3 /*break*/, 4];
                return [4 /*yield*/, inquirer.prompt({
                        type: 'autocomplete',
                        name: 'selected',
