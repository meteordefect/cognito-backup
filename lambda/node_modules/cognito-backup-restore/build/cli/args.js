...
exports.argv = yargs
    ...
    .option('region', {
    alias: ['r'],
    describe: dimmed(templateObject_11 || (templateObject_11 = __makeTemplateObject(["The region to use. Overrides config/env settings"], ["The region to use. Overrides config/env settings"]))),
    string: true,
})
    .option('profile', {
    alias: ['p'],
    describe: dimmed(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Use a specific profile from your credential file"], ["Use a specific profile from your credential file"]))),
    ...
    alias: ['metadata'],
    describe: dimmed(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Use iam role in ec2 instance."], ["Use iam role in ec2 instance."]))),
    type: 'boolean'
})
    .option('use-env-vars', {
    alias: ['env'],
    describe: dimmed(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Use credentials from environment variables."], ["Use credentials from environment variables."]))),
    type: 'boolean'
})
    .option('userpool', {
    alias: ['pool'],
    describe: dimmed(templateObject_17 || (templateObject_17 = __makeTemplateObject(["The Cognito pool to use. 'all' to backup all userpools."], ["The Cognito pool to use. 'all' to backup all userpools."]))),
    string: true
})
    .option('delay', {
    describe: dimmed(templateObject_18 || (templateObject_18 = __makeTemplateObject(["delay in millis between alternate users batch(60) backup, to avoid rate limit error"], ["delay in millis between alternate users batch(60) backup, to avoid rate limit error"]))),
    number: true
})
    // help
